...
export default function ProductCard({
  ...
  return (
    <>
      <div className="group flex flex-col bg-white rounded-xl border border-[#E5D9C8]/80 p-3.5 shadow-xs hover:shadow-md hover:border-[#C59B27]/70 transition-all duration-300 transform hover:-translate-y-0.5">
        {/* Saree Image Container — portrait */}
        <div 
          onClick={() => setIsModalOpen(true)}
          className="relative aspect-[4/5] w-full overflow-hidden bg-[#FAF7EC] mb-3 cursor-pointer rounded-lg border border-[#FAF7EC]"
        >
          <Image
        ...
        <div className="space-y-1 mb-3 flex-1">
          {/* Fabric Muted Header */}
          <p className="text-[9px] font-bold uppercase tracking-widest text-[#8A786D] block leading-none">
            {fabric || 'Premium Silk'}
          </p>
          ...
          >
            <h3 className="font-serif-luxury text-xs sm:text-sm font-semibold text-[#6A2B15] group-hover:text-[#B84D28] transition-colors leading-snug line-clamp-1">
              {name}
            </h3>
          </button>
          ...
          <div className="flex items-baseline gap-1.5 pt-0.5">
            <span className="font-serif-luxury text-xs sm:text-base font-bold text-[#6A2B15]">
        ...
        <div className="flex gap-1.5 w-full">
          ...
          <button
            ...
            className={`flex-grow inline-flex items-center justify-center gap-1 border py-1.5 px-1.5 text-[8.5px] sm:text-[9.5px] font-bold tracking-widest uppercase rounded-md transition-all duration-300 ${
              addedToCart
                ? 'bg-[#1E5631] text-white border-[#1E5631]'
                : 'bg-transparent hover:bg-[#6A2B15] border-[#E5D9C8] hover:border-[#6A2B15] text-[#8C3B1F] hover:text-[#FFFFF0]'
            }`}
          >
            {addedToCart ? (
              <>
          ...
          <a
            ...
            className="inline-flex items-center justify-center p-2 bg-[#1E5631] hover:bg-[#153e22] text-white border border-[#1E5631] rounded-md transition-all duration-300"
          >
