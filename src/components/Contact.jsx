...
export default function Contact() {
    ...
    return (
        <div className="w-full bg-[#FFFFF0]">
            ...
            {/* ========================================================= */}
            <section id="promises" className="w-full py-6 sm:py-12 lg:py-16 px-2 sm:px-6 lg:px-8 border-t border-[#E5D9C8]">
                <div className="max-w-7xl mx-auto">
                    {/* Header */}
                    <div className="text-center mb-4 sm:mb-10">
                        <div className="inline-flex items-center justify-center gap-1.5 sm:gap-2 text-[#8C3B1F] uppercase tracking-[0.2em] sm:tracking-[0.25em] text-[10px] sm:text-xs font-bold">
                            <LotusIcon className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#B84D28]" />
                    ...
                    <div className="bg-[#FAF7EC]/70 rounded-2xl p-2.5 sm:p-8 border border-[#E5D9C8] shadow-sm">
                        <div className="grid grid-cols-4 divide-x divide-[#E5D9C8]/60 gap-1 sm:gap-6">
                            {promises.map((item, idx) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div className="w-7 h-7 sm:w-14 sm:h-14 rounded-full bg-[#FFFFF0] border border-[#C59B27]/40 flex items-center justify-center text-[#B84D28] shadow-xs hover:scale-105 transition-transform duration-300 flex-shrink-0">
                                            <IconComp className="w-3.5 h-3.5 sm:w-7 sm:h-7 stroke-[1.5]" />
                                        </div>
                                        <h3 className="font-serif-luxury text-[9px] sm:text-xl font-medium text-[#6A2B15] tracking-tight sm:tracking-wide leading-tight text-center">
                                            {item.title}
                                        </h3>
            ...
            {/* SECTION 2: CONTACT US                                     */}
            {/* ========================================================= */}
            <section id="contact" className="w-full py-6 sm:py-12 lg:py-16 px-3 sm:px-6 lg:px-8 relative overflow-hidden bg-[#FFFFF0]">
                {/* Background Subtle Gradient Overlay */}
                <div className="absolute inset-0 pointer-events-none opacity-40 bg-[radial-gradient(ellipse_at_bottom_right,_var(--tw-gradient-stops))] from-[#B84D28]/5 via-transparent to-transparent" />

                <div className="max-w-7xl mx-auto relative z-10">

                    {/* Section Header */}
                    <div className="text-left mb-4 sm:mb-8">
                        <div className="inline-flex items-center gap-1.5 sm:gap-2 text-[#8C3B1F] uppercase tracking-[0.18em] sm:tracking-[0.25em] text-[9px] sm:text-xs font-bold mb-1">
                            <span>Contact Us</span>
                            <LotusIcon className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#B84D28]" />
                        </div>
                        <h2 className="font-serif-luxury text-base sm:text-4xl lg:text-5xl font-normal text-[#6A2B15] tracking-tight leading-tight">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-8 lg:gap-12 items-start">
                        ...
                        <div className="lg:col-span-5 space-y-2.5 sm:space-y-6">
                            ...
                            {/* Phone */}
                            <div className="flex items-start gap-2.5 sm:gap-4 p-2.5 sm:p-4 rounded-lg sm:rounded-xl bg-[#FAF7EC]/50 border border-[#E5D9C8]/70 hover:border-[#B84D28]/40 transition-colors">
                                <div className="w-7 h-7 sm:w-10 sm:h-10 rounded-full bg-[#FFFFF0] border border-[#C59B27]/40 flex items-center justify-center text-[#8C3B1F] flex-shrink-0">
                                    <Phone className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#B84D28]" />
                                </div>
                                <div>
                                    <h4 className="font-serif-luxury text-xs sm:text-base font-semibold text-[#6A2B15] tracking-wide">
                                        Phone
                                    </h4>
                                    <a
                                        href="tel:+919746598789"
                                        className="text-[10px] sm:text-sm text-[#4A3B32] hover:text-[#B84D28] transition-colors"
                                    >
                                        +91 97465 98789
                                    </a>
                                </div>
                            ...
                            <div className="flex items-start gap-2.5 sm:gap-4 p-2.5 sm:p-4 rounded-lg sm:rounded-xl bg-[#FAF7EC]/50 border border-[#E5D9C8]/70 hover:border-[#B84D28]/40 transition-colors">
                                <div className="w-7 h-7 sm:w-10 sm:h-10 rounded-full bg-[#FFFFF0] border border-[#C59B27]/40 flex items-center justify-center text-[#8C3B1F] flex-shrink-0">
                                    <Mail className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#B84D28]" />
                                </div>
                                <div>
                                    <h4 className="font-serif-luxury text-xs sm:text-base font-semibold text-[#6A2B15] tracking-wide">
                                        Email
                            ...
                            <div className="flex items-start gap-2.5 sm:gap-4 p-2.5 sm:p-4 rounded-lg sm:rounded-xl bg-[#FAF7EC]/50 border border-[#E5D9C8]/70 hover:border-[#B84D28]/40 transition-colors">
                                <div className="w-7 h-7 sm:w-10 sm:h-10 rounded-full bg-[#FFFFF0] border border-[#C59B27]/40 flex items-center justify-center text-[#8C3B1F] flex-shrink-0">
                                    <MapPin className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#B84D28]" />
                                </div>
                                <div>
                                    <h4 className="font-serif-luxury text-xs sm:text-base font-semibold text-[#6A2B15] tracking-wide">
                                        Address
                            ...
                            <div className="lg:hidden p-3 sm:p-5 rounded-xl sm:rounded-2xl bg-gradient-to-br from-[#8C3B1F] to-[#6A2B15] text-[#FFFFF0] relative overflow-hidden shadow-md">
                                ...
                                <p className="text-[10px] sm:text-xs text-[#FAF7EC]/90 leading-relaxed">
                            ...
                            <div className="hidden lg:block space-y-5 pt-1">
                                <div>
                                    <p className="text-[10px] tracking-[0.2em] font-bold uppercase text-[#8C3B1F] mb-3">Follow Us</p>
                                    <div className="flex items-center gap-3">
                                        <a
                                            ...
                                            className="w-10 h-10 rounded-full bg-[#FFFFF0] border border-[#E5D9C8] flex items-center justify-center text-[#8C3B1F] hover:border-[#B84D28] hover:text-[#B84D28] transition-all duration-200"
                                        >
                                ...
                                <div className="flex items-center gap-3 text-[#4A3B32]">
                                    <div className="w-9 h-9 rounded-full bg-[#FFFFF0] border border-[#C59B27]/40 flex items-center justify-center flex-shrink-0">
                                        <Clock className="w-4 h-4 text-[#B84D28]" />
                                    </div>
                                    <p className="text-xs leading-relaxed">We usually respond within <span className="font-semibold text-[#6A2B15]">24 hours</span>.</p>
                                </div>
                            </div>
                        ...
                        <div className="lg:col-span-7 relative">
                            <div className="bg-[#FAF7EC]/60 rounded-xl sm:rounded-2xl p-3.5 sm:p-8 border border-[#E5D9C8] shadow-sm relative z-10">

                                {submitted ? (
                                    <div className="bg-[#8C3B1F] text-[#FFFFF0] rounded-xl p-4 sm:p-6 text-center space-y-3 animate-in fade-in duration-300">
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-2.5 sm:space-y-4">
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-4">
                                            <div>
                                                <input
                                                    ...
                                                    className="w-full bg-[#FFFFF0] border border-[#E5D9C8] rounded-md px-3 py-2 sm:px-4 sm:py-2.5 text-[11px] sm:text-sm text-[#6A2B15] placeholder-[#8C7A70] focus:outline-none focus:border-[#B84D28] transition-colors"
                                                />
                                            </div>
                                            <div>
                                                <input
                                        ...
                                        <div>
                                            <textarea
                                                ...
                                                className="w-full bg-[#FFFFF0] border border-[#E5D9C8] rounded-md px-3 py-2 sm:px-4 sm:py-2.5 text-[11px] sm:text-sm text-[#6A2B15] placeholder-[#8C7A70] focus:outline-none focus:border-[#B84D28] transition-colors resize-none"
                                            />
                                        </div>
                                        ...
                                        <div>
                                            <button
                                                type="submit"
                                                disabled={loading}
                                                className="inline-flex items-center justify-center gap-1.5 sm:gap-2 bg-[#8C3B1F] hover:bg-[#A34320] text-[#FFFFF0] text-[10px] sm:text-xs font-bold tracking-widest uppercase px-4 py-2.5 sm:px-6 sm:py-3 rounded-md shadow-md transition-all duration-300 hover:shadow-lg disabled:opacity-50"
                                            >
